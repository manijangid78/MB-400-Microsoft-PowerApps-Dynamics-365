...
![Screen image of grid displaying entities contained in the permit management solution.](Static/Mod_01_Data_Modeling_image1.png)
...
![Select environment - screenshot](Static/Mod_01_Data_Modeling_image3.png)
...
![New publisher - screenshot](Static/Mod_01_Data_Modeling_image4.png)

	- Enter **Contoso** for **Display Name** and **contoso** for **Prefix.** 

	- Click **Save and Close**.

![Save publisher - screenshot](Static/Mod_01_Data_Modeling_image5.png)
...
![Add existing entity - screenshot](Static/Mod_01_Data_Modeling_image6.png)
...
![Select entity components - screenshot](Static/Mod_01_Data_Modeling_image7.png)
...
![Add components](Static/Mod_01_Data_Modeling_image8.png)
...
![Add new entity - screenshot](Static/Mod_01_Data_Modeling_image9.png)
...
![Add field - screenshot](Static/Mod_01_Data_Modeling_image10.png)
...
![Change filter to custom - screenshot](Static/Mod_01_Data_Modeling_image11.png)

	- Click **Save Entity**.

![Save entity - screenshot](Static/Mod_01_Data_Modeling_image12.png)
...
![Navigation breadcrumbs - screenshot ](Static/Mod_01_Data_Modeling_image13.png)
...
![Primary field properties - screenshot](Static/Mod_01_Data_Modeling_image14.png)
...
![Field properties - screenshot](Static/Mod_01_Data_Modeling_image15.png)
...
![New option set - screenshot](Static/Mod_01_Data_Modeling_image16.png)

	- Enter **Initial Inspection** and click **Add New Item**.

![Add new option-set item - screenshot](Static/Mod_01_Data_Modeling_image17.png)

	- Enter **Final Inspection** and click **Save**.

![Option-set options - screenshot](Static/Mod_01_Data_Modeling_image18.png)
...
![Publish customizations - screenshot](Static/Mod_01_Data_Modeling_image19.png)
...
![Switch to classic - screenshot](Static/Mod_01_Data_Modeling_image20.png)
...
![Select fields - screenshot](Static/Mod_01_Data_Modeling_image21.png)

	- Locate and double click to open the **statuscode** field.

![Open field for edit - screenshot](Static/Mod_01_Data_Modeling_image22.png)
...
![Edit option - screenshot](Static/Mod_01_Data_Modeling_image23.png)

	- Change the **Label** to **New Request** and click **OK**.

![Change option label - screenshot](Static/Mod_01_Data_Modeling_image24.png)

5. Add the Pending Option

	- Click **Add**.

![Add new option - screenshot](Static/Mod_01_Data_Modeling_image25.png)
...
![Option-set options - screenshot](Static/Mod_01_Data_Modeling_image26.png)

	10. Select Pending as the Default Value and click **Save and Close** from the top menu.

![Select option-set default option - screenshot](Static/Mod_01_Data_Modeling_image27.png)

	11. Edit Permit entity Status Reason options

		- Expand the **Permit** entity and select **Fields**.

![Select entity fields - screenshot](Static/Mod_01_Data_Modeling_image28.png)
...
![Option-set options - screenshot](Static/Mod_01_Data_Modeling_image29.png)
...
![Save and close solution explorer - screenshot](Static/Mod_01_Data_Modeling_image30.png)
...
![Many to one relationship - screenshot](Static/Mod_01_Data_Modeling_image31.png)

	- Select Contact for **Related (One)** and click **Done**.

![Relationship properties - screenshot](Static/Mod_01_Data_Modeling_image32.png)
...
![Relationship advanced options - screenshot](Static/Mod_01_Data_Modeling_image33.png)

	- Change the **Type of Behavior** to **Parental** and click **Done**.

![Relationship behavior - screenshot](Static/Mod_01_Data_Modeling_image34.png)
...
![Relationship advanced options - screenshot](Static/Mod_01_Data_Modeling_image35.png)
...
![Change filter - screenshot](Static/Mod_01_Data_Modeling_image36.png)

	7. Click **Save Entity**.

![Save entity - screenshot](Static/Mod_01_Data_Modeling_image37.png)
